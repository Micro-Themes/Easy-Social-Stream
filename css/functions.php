...
function wpsocial_stream_admin_menus(){
	...
	add_submenu_page( 'easy-social-stream', esc_attr__( 'Dribble', 'easySocialLogin' ), esc_attr__( 'Dribble', 'easySocialLogin' ), 'manage_options', 'wpsocial_stream_dribble', 'wpsocial_stream_dribble' );
